...
const Gallery:React.FC<{ closeModal: () => void, images: Image[] }> = ({ closeModal, images }) => {
    const [selected, setSelected] = useState<null| Image>(null);
                ...
                <div className="flex flex-col h-full pt-10 pb-20">
                    ...
                    <div className="flex-1 relative">                                
                        ...
                        <div className="absolute top-0 left-0 w-full h-full flex gap-x-14 items-start">
                            ...
                            <div className={isStrech ? 'hidden' : 'w-1/5'}>
                                <h1 className="text-fuscous-grayd text-2xl">{selected?.description[i18n.resolvedLanguage as keyof typeof Image]}</h1>
                            </div>
                        </div>
                        
                    </div>

                    <div className={isStrech ? 'hidden' : ''}>
